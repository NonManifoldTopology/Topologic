...
{
    public class VertexY : GH_Component
    {

        public VertexY()
          : base("Vertex.Y", "Vertex.Y", "Returns the Y coordinate of the Vertex.", "Topologic", "Vertex")
        {
        }
        ...
        {
            get { return new Guid("435c5412-d308-44ff-a3ea-e8b0952a2c4b"); }
        }
    }
}
