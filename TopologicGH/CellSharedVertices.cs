...
{
    public class CellSharedVertices : GH_Component
    {
        ...
        {
            pManager.AddGenericParameter("SharedVertices", "SharedVertices", "SharedVertices", GH_ParamAccess.list);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            IList<Topologic.Vertex> vertices = cell1.SharedVertices(cell2);
        ...
        {
            get { return new Guid("e1945951-1230-4059-b3e0-554d51aae7b8"); }
        }
    }
}
