...
{
    public class WireUtilityAdjacentCells : GH_Component
    {
        public WireUtilityAdjacentCells()
          : base("WireUtility.AdjacentCells", "WireUtility.AdjacentCells", "Returns a list of Cells that are the adjacent to the input Wire.", "TopologicUtilities", "WireUtility")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            IEnumerable<global::Topologic.Cell> adjacentCells = global::Topologic.Utilities.WireUtility.AdjacentCells(wire, parentTopology);
        ...
        {
            get { return new Guid("8ee15501-f807-46a4-b0fb-c3cc7e621e72"); }
        }
    }
}
