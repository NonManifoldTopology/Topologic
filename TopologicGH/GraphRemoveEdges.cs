...
{
    public class GraphRemoveEdges : GH_Component
    {

        public GraphRemoveEdges()
          : base("Graph.RemoveEdges", "Graph.RemoveEdges", "Removes the input Edges from the Graph.", "Topologic", "Graph")
        {
        }
        ...
        {
            get { return new Guid("a93fb0f0-f74f-46af-984d-742d86768653"); }
        }
    }
}
