...
{
    public class TopologyMerge : GH_Component
    {

        public TopologyMerge()
          : base("Topology.Merge", "Topology.Merge", "Merges the input Topology and another Topology.", "Topologic", "Topology")
        {
        }
        ...
        {
            get { return new Guid("fdeb3761-08b6-4997-93c2-eca1a0ff2e2b"); }
        }
    }
}
