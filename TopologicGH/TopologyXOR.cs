...
{
    public class TopologyXOR : GH_Component
    {

        public TopologyXOR()
          : base("Topology.XOR", "Topology.XOR", "Performs an XOR operation between the input Topology and another Topology.", "Topologic", "Topology")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Topologic.Topology newTopology = topology.XOR(otherTopology, transferDictionary);
        ...
        {
            get { return new Guid("191c1f36-cd50-4225-8914-dba8d5950d5c"); }
        }
    }
}
