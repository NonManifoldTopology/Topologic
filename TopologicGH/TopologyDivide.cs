...
{
    public class TopologyDivide : GH_Component
    {

        public TopologyDivide()
          : base("Topology.Divide", "Topology.Divide", "Divides the input Topology with another Topology.", "Topologic", "Topology")
        {
        }
        ...
        {
            get { return new Guid("83ff609b-4f6c-479e-b9e7-621d4e1c2ea3"); }
        }
    }
}
