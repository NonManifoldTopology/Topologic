...
{
    public class GraphTopology : GH_Component
    {

        public GraphTopology()
          : base("Graph.Topology", "Graph.Topology", "Returns the Topology of the Graph.", "Topologic", "Graph")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Topologic.Topology topology = graph.Topology;
        ...
        {
            get { return new Guid("99a04aea-aa68-4698-9ab5-a519a661058a"); }
        }
    }
}
