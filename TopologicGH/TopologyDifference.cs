...
{
    public class TopologyDifference : GH_Component
    {

        public TopologyDifference()
          : base("Topology.Difference", "Topology.Difference", "Performs the Difference operation between the input Topology and another Topology.", "Topologic", "Topology")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Topologic.Topology newTopology = topology.Difference(otherTopology, transferDictionary);
        ...
        {
            get { return new Guid("ca312369-d8a6-406b-bba6-e83c09f4b5d1"); }
        }
    }
}
