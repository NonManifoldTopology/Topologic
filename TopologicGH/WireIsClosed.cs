...
{
    public class WireIsClosed : GH_Component
    {

        public WireIsClosed()
          : base("Wire.IsClosed", "Wire.IsClosed", "Checks if the Wire is closed.", "Topologic", "Wire")
        {
        }
        ...
        {
            get { return new Guid("30f8291a-8190-43ad-9255-982e1749f2e7"); }
        }
    }
}
