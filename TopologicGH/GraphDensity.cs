...
{
    public class GraphDensity : GH_Component
    {

        public GraphDensity()
          : base("Graph.Density", "Graph.Density", "Returns the ratio of the number of Edges to the total number of Edges the Graph could have.", "Topologic", "Graph")
        {
        }
        ...
        {
            get { return new Guid("69d3f62a-a9fe-4886-aff1-335216d2c92f"); }
        }
    }
}
