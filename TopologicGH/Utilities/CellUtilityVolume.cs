...
{
    public class CellUtilityVolume : GH_Component
    {

        public CellUtilityVolume()
          : base("CellUtility.Volume", "CellUtility.Volume", "Returns the volume of a Cell.", "TopologicUtilities", "CellUtility")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            double volume = Topologic.Utilities.CellUtility.Volume(cell);
        ...
        {
            get { return new Guid("83512261-ae95-4df7-b76e-6e49e9a1a18d"); }
        }
    }
}
