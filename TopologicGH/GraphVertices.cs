...
{
    public class GraphVertices : GH_Component
    {

        public GraphVertices()
          : base("Graph.Vertices", "Graph.Vertices", "Returns a list of all the Vertices in a Graph.", "Topologic", "Graph")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            IEnumerable<Topologic.Vertex> vertices = graph.Vertices;
        ...
        {
            get { return new Guid("b3d4f2c5-a172-46ec-b867-eb9082886179"); }
        }
    }
}
