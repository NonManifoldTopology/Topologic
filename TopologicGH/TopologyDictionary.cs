...
{
    public class TopologyDictionary : GH_Component
    {

        public TopologyDictionary()
          : base("Topology.Dictionary", "Topology.Dictionary", "Returns the dictionary of a Topology.", "Topologic", "Topology")
        {
        }
        ...
        {
            get { return new Guid("7a68ba4a-d697-46dd-b6d7-6657cdb122e9"); }
        }
    }
}
