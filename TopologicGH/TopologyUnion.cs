...
{
    public class TopologyUnion : GH_Component
    {

        public TopologyUnion()
          : base("Topology.Union", "Topology.Union", "Unions the input Topology and another Topology.", "Topologic", "Topology")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Topologic.Topology newTopology = topology.Union(otherTopology, transferDictionary);
        ...
        {
            get { return new Guid("9336d31e-3081-4390-9528-43a6a0ddd77f"); }
        }
    }
}
