...
{
    public class FaceUtilityAdjacentShells : GH_Component
    {
        public FaceUtilityAdjacentShells()
          : base("FaceUtility.AdjacentShells", "FaceUtility.AdjacentShells", "Returns a list of Shells that are the adjacent to the input Face.", "TopologicUtilities", "FaceUtility")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            IEnumerable<global::Topologic.Shell> adjacentShells = global::Topologic.Utilities.FaceUtility.AdjacentShells(face, parentTopology);
