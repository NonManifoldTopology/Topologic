...
namespace TopologicGH
{
    public class GraphEdgeAtVertices : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("Vertex 1", "Vertex 1", "Vertex 1", GH_ParamAccess.item);
            pManager.AddGenericParameter("Vertex 2", "Vertex 2", "Vertex 2", GH_ParamAccess.item);
        ...
        {
            get { return new Guid("11210c65-c4ff-4fb3-9130-e449615890e7"); }
        }
    }
}
