...
{
    public class TopologyType : GH_Component
    {

        public TopologyType()
          : base("Topology.Type", "Topology.Type", "Returns the type associated to the Topology.", "Topologic", "Topology")
        {
        }
        ...
        {
            get { return new Guid("71c43605-fac8-481f-9edb-aa2ca90311f5"); }
        }
    }
}
