...
namespace TopoLogic
{
	...
	Dictionary<String^, Object^>^ Shell::ByFaces(List<Object^>^ faces)
	{
		throw gcnew System::NotImplementedException();
		// TODO: insert return statement here
	}
	...
	Dictionary<String^, Object^>^ Shell::ByVerticesFaceIndices(List<Object^>^ vertices, List<List<int>^>^ faceIndices)
	{
		throw gcnew System::NotImplementedException();
		// TODO: insert return statement here
	}
