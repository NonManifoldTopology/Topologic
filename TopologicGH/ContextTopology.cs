...
{
    public class ContextTopology : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetData(0, ref context)) { return; }
            ...
            Topologic.Topology topology = context.Topology;
        ...
        {
            get { return new Guid("969bfc7a-4e0c-42f5-9d5c-c9f78bcfc144"); }
        }
    }
}
