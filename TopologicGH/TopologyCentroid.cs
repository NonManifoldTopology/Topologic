...
{
    public class TopologyCentroid : GH_Component
    {
        public TopologyCentroid()
          : base("Topology.Centroid", "Topology.Centroid", "Returns the centroid of any Topology.", "Topologic", "Topology")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Topologic.Vertex centroid = topology.Centroid;
        ...
        {
            get { return new Guid("4915fa13-ceab-4d3b-946c-14d219594691"); }
        }
    }
}
