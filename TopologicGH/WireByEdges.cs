...
{
    public class WireByEdges : GH_Component
    {

        public WireByEdges()
          : base("Wire.ByEdges", "Wire.ByEdges", "Creates a Wire by a set of Edges.", "Topologic", "Wire")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Topologic.Wire wire = Topologic.Wire.ByEdges(edges);
        ...
        {
            get { return new Guid("8300b7e1-b9e8-4288-bf0a-2f0e4a80ffe6"); }
        }
    }
}
