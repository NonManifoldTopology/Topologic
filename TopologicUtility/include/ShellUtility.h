...
namespace TopologicUtility
{
	...
	public:
		...
		/// <returns></returns>
		static TOPOLOGIC_SUPPORT_API TopologicCore::Shell::Ptr ByVerticesFaceIndices(const std::vector<TopologicCore::Vertex::Ptr>& rkVertices, const std::list<std::list<int>>& rkFaceIndices);
		...
		/// <returns></returns>
		static TOPOLOGIC_SUPPORT_API TopologicCore::Shell::Ptr ByLoft(const std::list<TopologicCore::Wire::Ptr>& rkWires);
		...
		/// <returns></returns>
		static TOPOLOGIC_SUPPORT_API TopologicCore::Shell::Ptr ByFacePlanarization(
		...
		static TOPOLOGIC_SUPPORT_API TopologicCore::Shell::Ptr ByFacePlanarizationV2(
			const TopologicCore::Face::Ptr& kpFace,
			const int kIteration,
			const int kEdgeSamples,
			const std::list<double>& rkUValues,
